   ...
   //   function addMessage(sender, message) {
    ...
    //  }
      ...
      function chatbotResponse(message) {
          var response;
          showLoader(); // Gekleurd bolletje tonen
          ...
          case "taalmodel":
              response = "AryaLM is het taalmodel waar ik op draai. Elk taalmodel komt met nieuwe functies en een hogere intelligentie. Hiernaast kan je kiezen welk taalmodel je wilt gebruiken. Kan ik je nog ergens anders mee helpen?";
              break;
            ...
            case "idioot":               
                ...
                case "stink jij?":
                case "stink jij":
                    response = "Als chatbot kan ik geen geur verspreiden en kan ik dus ook niet stinken. Kan ik je nog ergens anders mee helpen?";
                    break;
                ...
                case "nigga!":
                case "nigga":
                        response = "Scheldwoorden zijn hier niet toegestaan, dus laten we proberen vriendelijk te zijn! Als je normaal kan doen, kan ik je dan nog ergens anders mee helpen?";
                        break;
...
function addTypewriterEffect(element, message, delay = 8) {
    let i = 0;
    const addChar = () => {
        if (i < message.length) {
    ...
    if (event.key === "Enter") {
        ...
        if (userMessage !== "") {
            ...
            setTimeout(function() {
                ...
                }, 1550); // Vertraag voordat de reactie verschijnt
            }, 350);
        }
    }
});
...
function sendInput(input) {
    ...
    fetch(formUrl, {
      ...
      console.log('Invoer succesol verzonden! Bedankt voor het gebruiken van Arya en dankzij jouw anonieme data wordt Arya nog slimmer!');
    }).catch(error => {
      console.error('Er is iets misgegaan! Error:', error);
    });
  }
